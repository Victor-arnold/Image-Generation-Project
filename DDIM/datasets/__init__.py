...
def get_dataset(args, config):
    ...
    #     )
    if config.data.dataset == "CIFAR10":
        store_path = r'/Users/zhangzijun/Desktop/ddim-main/datasets/cifar'
        name = {'horse':0}
        #name = {'airplane':0, 'automobile':1, 'bird':2, 'cat':3, 'deer':4, 'dog':5, 'frog':6, 'horse':7, 'ship':8, 'truck':9}
        
        split = 'train'
        dataset = my_dataset(store_path, split, name, tran_transform)
        
        split = 'test'
        test_dataset = my_dataset(store_path, split, name, test_transform)
